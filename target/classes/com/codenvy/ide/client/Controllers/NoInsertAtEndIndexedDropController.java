...
import com.codenvy.ide.client.Editor.Editor;
...
public class NoInsertAtEndIndexedDropController extends SimpleDropController {
    ...
    public void onDrop(DragContext context) {
        ...
        for (Widget widget : context.selectedWidgets) {
            ...
            newDroppedElem.addClickHandler(Editor.clickHandler);
            ...
            Editor.WidgetMap.put(ElementCount, newDroppedElem.getElement().getId());
        ...
        Editor.gwtjsPlumbDemo(prevElem, currElem, ElementCount);
